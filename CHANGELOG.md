...
## [16.7.0](https://github.com/tdslot/topgrade/compare/v16.6.1...v16.7.0) - 2025-12-11

### Added

- *(sudo)* propagate --env to sudo commands ([#1588](https://github.com/tdslot/topgrade/pull/1588)) ([#1589](https://github.com/tdslot/topgrade/pull/1589))
- *(aqua)* run `aqua update --config $AQUA_GLOBAL_CONFIG` instead of `aqua update` ([#1596](https://github.com/tdslot/topgrade/pull/1596))

### Other

- *(deps)* update itertools to 0.14.0 ([#1601](https://github.com/tdslot/topgrade/pull/1601))
- *(pre-commit)* autoupdate ([#1580](https://github.com/tdslot/topgrade/pull/1580))
- *(deps)* lock file maintenance ([#1597](https://github.com/tdslot/topgrade/pull/1597))
- *(deps)* update github/codeql-action action to v4.31.7 ([#1591](https://github.com/tdslot/topgrade/pull/1591))
- *(deps)* update release-plz/action digest to 487eb7b ([#1590](https://github.com/tdslot/topgrade/pull/1590))
